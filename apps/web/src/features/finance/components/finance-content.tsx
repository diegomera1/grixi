          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--bg-muted)]/50 px-3 py-1.5 text-xs font-medium text-[var(--text-primary)] transition-all hover:border-[var(--border-hover)]"
              >
                <span className="text-sm">{CURRENCY_CONFIG[currency].flag}</span>
                <span>{currency}</span>
                <ChevronDown className={cn("w-3.5 h-3.5 text-[var(--text-muted)] transition-transform", currencyOpen && "rotate-180")} />
              </button>
              <AnimatePresence>
                {currencyOpen && (
                  <>
                    ...
                    <motion.div
                      ...
                      className="absolute right-0 top-full z-[60] mt-1.5 w-48 rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] p-1 shadow-xl"
                    >

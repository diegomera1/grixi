      ...
      <div className="text-center max-w-md px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg border border-(--border) text-(--text-secondary) text-sm font-medium hover:bg-(--bg-muted) transition-colors"
          >
            <ArrowLeft size={16} />

...
function getSecurityHeaders(): Record<string, string> {
  return {
    ...
    "Content-Security-Policy": [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://generativelanguage.googleapis.com https://accounts.google.com https://login.microsoftonline.com https://graph.microsoft.com",
